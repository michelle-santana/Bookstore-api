...
public class DBService {
	...
	public void instantiateDatabase() {
		...
		Categoria cat4 = new Categoria(null, "Ficção", "E.T");
		...
		Livro liv4 = new Livro(null, "Amanhecer", "Gianina brown", "lore ypisun", cat2);
		Livro liv5 = new Livro(null, "Aprendendo Java", "JJ abrahm", "lore ypisun", cat1);
		Livro liv6 = new Livro(null, "Cartas para você", "Jordan Sparkle", "lore ypisun", cat2);

		cat1.getLivros().addAll(Arrays.asList(liv1));
		
		this.categoriaRepository.saveAll(Arrays.asList(cat1, cat2, cat3, cat4));
		this.livroRepository.saveAll(Arrays.asList(liv1, liv2, liv3, liv4, liv5, liv6));
	}
